...
# -*- coding: utf-8 -*-
#
# catpy documentation build configuration file, created by
...
version = catpy.__version__
# The full version, including alpha/beta/rc tags.
release = catpy.__version__
...
# [howto/manual]).
latex_documents = [
    ("index", "catpy.tex", u"catpy Documentation", u"Andrew S. Champion", "manual")
]
...
man_pages = [("index", "catpy", u"catpy Documentation", [u"Andrew S. Champion"], 1)]
...
exclude_module_paths = ["../catpy/author.py", "../catpy/version.py"]
